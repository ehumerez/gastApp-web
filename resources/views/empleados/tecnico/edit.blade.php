...
@section('content')
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>Editar Técnico: {{$tecnico->nombres}} {{$tecnico->apellido_paterno }} {{$tecnico->apellido_materno}}</h2>
            <ol class="breadcrumb">
                <li>
                    Instalación
                </li>
            ...
            <div class="col-md-8">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <div>
                            {!! Form::model($tecnico,['route' => ['tecnico/update',$tecnico->ci],'method'=>'POST','class' => 'form-horizontal', 'name' => 'frm-data-store-tecnico', 'id' => 'frm-data-store-tecnico']) !!}

                            <div class="form-group validate-tecnico" id="div-ci">
                                <label class="col-sm-2 control-label">Cédula de Identidad *</label>
                                <div class="col-sm-10">
                                    {!! Form::number('ci', $tecnico->ci,['class'=>'form-control']) !!}
                                </div>
                            ...
                            <div class="form-group validate-cliente" id="div-nombres">
                                ...
                                <div class="col-sm-10">
                                    {!! Form::text('nombres', $tecnico->nombres,['class'=>'form-control']) !!}
                                </div>
                            ...
                            <div class="form-group validate-cliente" id="div-apellido_paterno">
                                ...
                                <div class="col-sm-10">
                                    {!! Form::text('apellido_paterno', $tecnico->apellido_paterno,['class'=>'form-control']) !!}
                                </div>
                            ...
                            <div class="form-group validate-cliente" id="div-apellido_materno">
                                ...
                                <div class="col-sm-10">
                                    {!! Form::text('apellido_materno', $tecnico->apellido_materno,['class'=>'form-control']) !!}
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group m-b">
                                        ...
                                        {!! Form::number('telefono_fijo', $tecnico->telefono_fijo,['class'=>'form-control']) !!}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group m-b">
                                        ...
                                        {!! Form::number('telefono_celular', $tecnico->telefono_celular,['class'=>'form-control']) !!}
                                    </div>
                                </div>
                            </div>
