    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong>Editar Medidor {{ $data->id }}</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        {!! Form::model($data,['route' => ['medidor/actualizar',$data->id],'method' => 'POST','class' => 'form-horizontal', 'name' => 'frm-data-medidores-edit', 'id' => 'frm-data-medidores-edit']) !!}
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Consumo (m^3)</label>
                            <div class="col-sm-10">
                                <input type="number" name="consumo_m3" class="form-control" value="{{ $data->consumo_m3 }}">
